...
gulp.task('copy', function() {
  ...
  // LightSlider
  var LightSlider = gulp.src('node_modules/lightslider/dist/**/*.*')
      .pipe($.flatten())
      .pipe(gulp.dest('assets/javascript/vendor/lightslider'));
  ...
  return merge(motionUi, whatInput, fontAwesome,LightSlider);
});
